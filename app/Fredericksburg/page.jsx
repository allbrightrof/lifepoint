...
import TwoCard from "@/components/sixTeam/TwoCard"
import { TwoCards } from "@/data/features";
...
const page = () => {
  ...
  <Navbar variant = "transparent" />
    <div className="relative w-full min-h-[90vh] sm:min-h-screen">
        <Image src="/fredericksburg.jpg" alt="one" width={400} height={300} className="absolute top-0 left-0 w-full h-full object-cover mb-2" />
        ...
        <div className="absolute top-0 left-0 w-full h-full z-10 flex flex-col justify-center items-center px-4 sm:px-8 lg:px-16 py-20">
         <h2 className='text-center font-bold text-white text-3xl sm:text-4xl lg:text-7xl p-5'>Fredericksburg Campus</h2>
  </div>
  </div>
...
Welcome
    ...
    <h3 className="text-2xl font-gbold lg:text-5xl text-black">Its not a coincidence <br/> that you found this page.</h3>
...
<TwoCard data={TwoCards} />
</div>
   <div className="bg-[#f4f4f4] lg:py-20 py-3 p-4">
...
<FontAwesomeIcon icon={faArrowRight} className="text-white"/> </span> </Link> 
                 ...
                 <TeamFeature group="campusstaffs"/>
                 </div>
                  <EvtPict evenData={morePic}/>
                    <div className="flex flex-col items-center justify-center mx-auto lg:py-15 py-10 gap-4 max-w-2xl text-center text-black">
    <h3 className="text-2xl font-bold text-black">You re Invited to Easter at Lifepoint</h3>

    <p className="text-black text-xl">
    April 3 - 5, 2026
    </p>
     <p className="text-black text-xl">
 Our hope for you this Easter is simple: that you encounter 
 the hope of Jesus and will be reminded that He is still the King
    </p>
  </div>
    <Footer />
    </>
